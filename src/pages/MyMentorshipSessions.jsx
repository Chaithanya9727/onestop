...
import { 
  ...
  User, Briefcase, ChevronRight, AlertCircle, Loader, X, ExternalLink
} from "lucide-react";
             ...
             <div className="bg-white dark:bg-[#0f1014] p-1.5 rounded-2xl border border-slate-200 dark:border-white/10 flex shadow-lg shadow-slate-200/50 dark:shadow-none">
                <button 
                   ...
                   className={`px-8 py-3 rounded-xl text-sm font-bold transition-all ${
                      tab === "upcoming" ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5'
                   }`}
                >
                   Upcoming
                </button>
                <button 
                   onClick={() => setTab("past")}
                   className={`px-8 py-3 rounded-xl text-sm font-bold transition-all ${
                      tab === "past" ? 'bg-slate-800 text-white dark:bg-white/10' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5'
                   }`}
                >
                   History
                </button>
                      ...
                      <div className="flex-1 min-w-0">
                         <div className="flex items-center gap-3 mb-3 flex-wrap">
                            <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${
                               session.status === 'confirmed' ? 'bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400 border-green-200 dark:border-green-500/20' :
